package com.yang.stock.config.feign;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.yang.stock.config.exception.BaseException;
import com.yang.stock.config.jackson.JacksonConfig;
import com.yang.stock.config.result.Result;
import com.yang.stock.config.result.ResultCode;
import com.yang.stock.config.util.MapUtil;
